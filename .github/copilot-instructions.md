...
## Commenting
 ...
 - When methods are defined in separate files, include inline comments next to the method signature in the class definition to provide a brief description of the method's purpose.