...
- [Weighted-staircase threshold](psychophysics/psychophysics_WeightedStaircase.md) — Hoover-corrected, balanced reversal threshold for asymmetric-step staircases
