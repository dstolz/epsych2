...
| Use common utilities | `obj/+utils/` | Shared functions for logging, GUI support, timing, randomization, analysis helpers, and small utilities previously in `helpers/`, now consolidated in `obj/+utils/`. |
