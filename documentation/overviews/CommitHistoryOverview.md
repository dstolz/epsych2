...
Period covered: 2019-05-14 through 2026-07-14

Only months with recorded commits are listed below.

## 2026

- July 2026, 11 commits. Parameter dispatch gained the per-parameter "Update Every Trial" flag, GUI components moved to the cached `Runtime.P` parameter struct, and the phase selector workflow was refined. An experimental `epsych://` URL protocol for config loading was added and then removed in favor of simpler startup options.
