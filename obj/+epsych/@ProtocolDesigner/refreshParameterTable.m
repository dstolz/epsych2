...
% Rebuild the parameter table from the current interface and module filters.
    ...
    obj.TableParams.ColumnFormat = {'char', 'char', obj.getTypeOptions(), 'char', 'char', 'numeric', 'numeric', 'logical', obj.getPairDropdownOptions(), obj.getAccessOptions(), 'char', 'logical', 'logical', 'char'};
    ...
    %   Min, Max, Random, Pair, Access, Unit, Visible, Trigger, Description
    fullWidths = {154, 112, 78, 148, 104, 58, 58, 66, 84, 88, 64, 58, 58, 170};
    if strcmp(obj.DropDownTableView.Value, 'Simple')
        ...
        obj.TableParams.ColumnWidth = {200, 146, 101, 192, 136, 0, 0, 0, 0, 0, 0, 0, 0, 0};
    else
