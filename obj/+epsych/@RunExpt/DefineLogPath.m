...
% obj.DefineLogPath
% Prompt for and persist the directory the +granary daily error logs are written
...
%
% See also: granary.setLogDir, granary.defaultLogDir, epsych.RunExpt.OpenCustomizeDialog

startDir = granary.defaultLogDir();
