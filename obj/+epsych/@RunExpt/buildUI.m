...
self.H.mnu_stim_player = uimenu(mUtil,'Label','Stimulus Player...','Separator','on', ...
    'MenuSelectedFcn', @(~,~) self.LaunchUtility("StimPlayer"));
self.H.mnu_stim_inspector = uimenu(mUtil,'Label','Stimulus Inspector...', ...
...
self.H.mnu_calibration = uimenu(mUtil,'Label','Calibration GUI...','Enable','on', ...
...
self.H.mnu_vlc_setup = uimenu(mUtil,'Label','Webcam Recorder Setup...','Enable','on', ...
    'Accelerator','W', ...
