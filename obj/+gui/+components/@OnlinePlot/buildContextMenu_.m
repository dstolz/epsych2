...
%
% See also: gui.components.OnlinePlot.refreshMenuChecks_, gui.components.OnlinePlot.savePreferences_
...
try
    ...
    vprintf(3,'gui.components.OnlinePlot: context menu unavailable: %s',ME.message)
end
end
