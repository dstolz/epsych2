...
% a half-applied one.
%
% See also: gui.OnlinePlot.savePreferences_
...
try
    ...
    vprintf(3,'gui.OnlinePlot: restored saved layout "%s"',pname)
catch ME
    vprintf(2,'gui.OnlinePlot: failed to load preferences: %s',ME.message)
