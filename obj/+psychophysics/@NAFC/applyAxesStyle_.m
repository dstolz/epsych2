...
% applyAxesStyle_(obj)
% Apply the NAFC plot's visual style to the axes chrome: a recessive grid
% and rulers so the choice curves, which carry the data, dominate. Matches
% the psychophysics.Staircase plot style so the two read as one family.
%
% Parameters:
